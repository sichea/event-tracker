...
- 사용자가 입력한 기업명이 한국 거래소(KOSPI/KOSDAQ)에 상장된 공식 명칭과 '정확히 일치'하는 경우에만 분석을 진행하세요. 만약 'HD현대마린'(공식명: HD현대마린솔루션), '미래에셋'(공식명: 미래에셋증권), '삼성'(공식명: 삼성전자), '현대'(공식명: 현대차)처럼 공식 상장사명이 아닌 약칭, 줄임말, 또는 불확실한 별칭을 입력한 경우 절대 임의로 매칭하여 분석을 완수하지 마세요. 대신 해당 기업의 정확한 상장사 공식 명칭을 확인하여 반드시 아래 형식으로 오류를 반환하세요 (예시를 참고해 유저가 무엇으로 검색해야 하는지 가이드해 주세요):
{"error": true, "message": "정확한 공식 상장사명(예: HD현대마린솔루션)으로 검색해 주세요."}
