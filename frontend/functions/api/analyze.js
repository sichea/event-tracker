...
1. steps: 사건의 본질적 원인부터 시장의 숨겨진 이면, 자본의 이동 경로, 그리고 미래의 변곡점까지 **유기적이고 유려한 흐름의 에세이 형식**으로 분석하세요. 번호를 매기지 말고(1., 2. 금지), 각 문단이 깊이 있는 통찰을 담아 자연스럽게 이어지도록 하세요.
2. sector: 이 모든 인과관계의 끝에서 가장 강력한 폭발력을 가질 단 하나의 핵심 섹터
3. stocks: 해당 섹터의 주인공이 될 종목 3개 (한국/글로벌 균형 배치)
4. caution: 대중이 보지 못하는 결정적 리스크 한 가지
5. advice: **[회심의 통찰]** 시장의 판도를 뒤집는 단 하나의 전략적 제언

모든 답변은 한국어로 작성하며, 격조 있고 날카로운 문체를 유지하세요. 뻔한 소리는 배제하고 오직 차별화된 'Edge'에만 집중하세요.`;
