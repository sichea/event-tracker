...
1. steps: 자금의 흐름이 변화하는 과정을 4~5개의 문단으로 구성하세요. **절대 번호를 매기지 마세요(1., 1단계 등 금지).** 각 문단은 이전 문단과 자연스럽게 이어지는 인과관계와 시장 참여자들의 심리 변화, 자본의 파생 효과를 심도 있게 서술하세요.
2. sector: 대중이 간과하고 있지만 거대한 자본의 이동이 시작될 '숨겨진 수혜 섹터'를 선정하세요.
3. stocks: 해당 섹터 내에서 스마트 머니가 매집 중이거나 구조적 성장이 확실시되는 종목 3개를 한국/글로벌 균형 있게 추천하세요.
4. caution: 대중의 심리적 함정이나 시장이 간과하고 있는 리스크 변수 2개를 지적하세요.
5. advice: **[회심의 통찰]** 대중의 시각과 차별화되는 역발상적 제언을 한 문장으로 시작하여 전략적 리포트를 작성하세요.

모든 답변은 한국어로 작성하며, 번호를 매기지 않는 에세이 형식의 유려한 문체를 유지하세요. 볼드체(**) 등 마크다운 기호는 절대 사용하지 마세요.`;
