...
1. steps: 자금의 흐름이 변화하는 과정을 4~5단계의 **짧고 명확한 핵심 포인트**로 설명하세요. (각 단계는 2문장 이내로 간결하게 작성)
2. sector: 해당 상황에서 가장 강력한 펀더멘털 개선이 기대되는 핵심 투자 섹터 1개
3. stocks: 해당 섹터의 주인공이 될 종목 3개 (한국/글로벌 균형 배치)
4. caution: 가장 주의해야 할 결정적 리스크 변수 1개
5. advice: **[회심의 통찰]** 시장의 이면을 꿰뚫는 단 한 문장의 전략적 제언
